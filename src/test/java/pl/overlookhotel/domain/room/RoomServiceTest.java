...
class RoomServiceTest {
    ...
    @Test
    public void convertFromIntOptionsIntoBedTypeTest() {
    ...
    public void getAvailableRoomsShouldThrowExceptionWhenToDateIsBeforeFrom() {
        ...
        LocalDate to = LocalDate.parse("2020-11-03");
    ...
    public void getAvailableRoomsShouldReturnAllRoomsWhenNoReservations() {
        ...
        LocalDate from = LocalDate.parse("2020-11-03");
        LocalDate to = LocalDate.parse("2020-11-10");
    ...
    public void getAvailableRoomsShouldRemoveRoomIfReservationStartDateIsTheSame() {
        ...
        Guest guest = new Guest(1, "Tony", "Stark", 40, Gender.MALE);
